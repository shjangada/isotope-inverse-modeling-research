...
1. Loads `data/topography.mat` → `OLYMPICTOPO`
2. Builds 1-based `X`, `Y` grids to match MATLAB
3. Runs `d2_linear` → precipitation, `qs0`, `Hw`
4. Runs `drying` → drying ratio field
5. Runs `fractionation` → δD field
6. Plots two figures and saves:
